    ...
    *,
    ...
    actions: list[StrategyAction] = [
        StrategyAction(
            ...
            metadata={**event_metadata, "requested_price": entry.fill_price, "fill_price": entry.fill_price, "fill_timestamp": entry.fill_timestamp, "fill_candle_index": entry.fill_candle_index, "bars_waited": entry.bars_waited, "intrabar_policy": intrabar_policy_config.mode.value if intrabar_policy_config else "CONSERVATIVE"},
            requested_price=entry.fill_price,
        )
    ]

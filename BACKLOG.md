...
- Active task candidate (2026-05-23): Task 121 `SHARED_INDICATOR_CACHE_AND_AT_INDEX_PATTERN_DETECTION` (highest-priority implementation task after Task 120 profiling output).
